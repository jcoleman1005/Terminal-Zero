...
MAN_PAGES: Dict[str, str] = {
    ...
    "decrypt": "NAME\n    decrypt - Osiris diagnostic error translation daemon\n\nSYNOPSIS\n    decrypt\n\nDESCRIPTION\n    Analyzes the last stderr fault and emits plain-language recovery procedures.\n",
    "osiris-diagnostics": "NAME\n    osiris-diagnostics - Osiris diagnostic error translation daemon\n\nSYNOPSIS\n    osiris-diagnostics\n\nDESCRIPTION\n    Analyzes the last stderr fault and emits plain-language recovery procedures.\n",
    "apollo-diagnostics": "NAME\n    apollo-diagnostics - legacy alias for osiris-diagnostics\n\nSYNOPSIS\n    apollo-diagnostics\n",
    ...
    "osiris-net": "NAME\n    osiris-net - Osiris network interface diagnostic tool\n\nSYNOPSIS\n    osiris-net\n",
    "apollo-net": "NAME\n    apollo-net - legacy alias for osiris-net\n\nSYNOPSIS\n    apollo-net\n",
    ...
    "reboot": "NAME\n    reboot - restart workstation and reset recovery state\n\nSYNOPSIS\n    reboot\n\nDESCRIPTION\n    Flushes transient memory, removes save state, and restores workstation OSIRIS to initial cold boot state.\n",
